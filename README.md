...
1. (Optional) Use the Jupyter notebooks or python scripts in the `markdown_generator` folder to generate publication markdown files from BibTeX. Poems should be hand-authored as markdown files in `_poems/`.
